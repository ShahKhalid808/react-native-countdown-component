...
Run `npm install shahkhalid808/react-native-countdown-component --save` OR `yarn add shahkhalid808/react-native-countdown-component --save`
...
```javascript
import CountDown from 'shahkhalid808/react-native-countdown-component';
